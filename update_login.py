...
new_return = """  return (
    <main className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2 overflow-hidden bg-[#fff7fe] font-sans">
      
      {/* ─── LEFT SIDE: Visual Narrative ─── */}
      <section className="hidden md:block relative overflow-hidden h-screen aspect-square">
      ...
      <section className="flex flex-col items-center justify-center p-6 md:p-20 bg-[#fbf0fe] relative min-h-screen">
        ...
        <div className="w-full max-w-md">
          ...
          {/* Form Section */}
          <div className="bg-[#ffffff] rounded-xl p-8 shadow-[0_32px_64px_rgba(31,26,35,0.04)] border border-[#cfc2d6]/10">
            <div className="mb-8">
