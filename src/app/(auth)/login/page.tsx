      ...
      <section className="flex flex-col items-center justify-center p-6 md:p-8 bg-[#fbf0fe] relative h-screen overflow-y-auto w-full">
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#ffffff] rounded-[32px] p-8 shadow-[0_32px_64px_rgba(31,26,35,0.04)] border border-[#cfc2d6]/10">
            <div className="mb-8">
              <h2 className="text-2xl font-black text-[#1f1a23] tracking-tight">Welcome Back!</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative flex items-center group">
                  <div className="absolute left-4 text-[#4d4354]/30 group-focus-within:text-[#8127cf] transition-colors pointer-events-none">
                  ...
                  <Input
                    ...
                    className="w-full h-14 pl-12 pr-4 bg-[#fbf0fe] border-0 rounded-2xl focus:ring-2 focus:ring-[#8127cf]/20 focus:bg-white transition-all placeholder:text-[#4d4354]/25 text-[#1f1a23] font-bold shadow-none"
                    {...register("email")}
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative flex items-center group">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    className="w-full h-14 pl-12 pr-12 bg-[#fbf0fe] border-0 rounded-2xl focus:ring-2 focus:ring-[#8127cf]/20 focus:bg-white transition-all placeholder:text-[#4d4354]/25 text-[#1f1a23] font-bold shadow-none"
                    {...register("password")}
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                className="w-full h-14 bg-gradient-to-r from-[#8127cf] to-[#9c48ea] text-white font-black rounded-2xl shadow-lg shadow-[#8127cf]/25 hover:shadow-xl hover:shadow-[#8127cf]/30 active:scale-[0.98] transition-all flex items-center justify-center gap-2 mt-2 cursor-pointer disabled:opacity-50"
                disabled={isLoading}
              >
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button type="button" className="flex items-center justify-center gap-3 h-12 rounded-2xl bg-[#fbf0fe] hover:bg-[#f5eaf8] hover:shadow-md transition-all border border-[#cfc2d6]/10 cursor-pointer">
